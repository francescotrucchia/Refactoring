...
{
    private function assertDom($method, $expected)
    {
    ...
    {
      $this->assertDom('listContacts', file_get_contents(dirname(__FILE__).'/../data/index.html'));
    }
    
    public function testNew()
    {
       $this->assertDom('addContact', file_get_contents(dirname(__FILE__).'/../data/new.html'));
    }
